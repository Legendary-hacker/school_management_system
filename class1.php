<?php
include 'connect.php';
$sql = "SELECT first_name FROM primary1 LIMIT 2";
...
<body>
        ...
        <aside class="asAdmin">
            <div class="AdminSb">
                <nav>
                        ...
                        <a href="logout.php" class="button-container">
                            <span id="logoutButton" class="material-symbols-outlined">
                                logout
                                </span>
                            <h3>Logout</h3>
                        </a>
    ...
    <script src="systems.js?v=1"defer></script>
</body>
</html>
